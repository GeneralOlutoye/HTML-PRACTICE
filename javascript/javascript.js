...
// the static property is generally useful when we talk about caches or anything with
// aa fixed configuration. 
// NB: we can also make static methods.

// INHERITANCE: is a a term used to denote when a child class can use ("inherit") all 
